...
public class HttpServer {
	   ...
	   public static String makeUriString(boolean isSsl, String urlSuffix){
	        ...
	        if(isSsl){
	        	...
	        	//us = "https" + "://" + "10.125.224.112:8080/"+urlSuffix;
	        	...
	        	//us = "http" + "://" + "10.125.224.112:8080/"+urlSuffix;
	        }
	        return us;
	    }
	 ...
	 * @throws IOException
	 */
	public HttpResponse sendHttpClient1(boolean isSsl, String urlSuffix, String body)
			throws IOException {
